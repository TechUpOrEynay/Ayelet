import { Component, OnInit, Input, VERSION, Directive } from '@angular/core';
...
export class ContactProjectsComponent implements OnInit {
  ...
  //showDialog() {
  //let fileNameDialogRef: MatDialogRef<ContactDialogComponent>;
  //fileNameDialogRef = this.dialog.open(ContactDialogComponent, {
  //hasBackdrop: false,
  //data: {
  //  active: this.flag
  //}
  // });
  //fileNameDialogRef.afterClosed().pipe(
  //).subscribe((result) => {
  //if (result) {
