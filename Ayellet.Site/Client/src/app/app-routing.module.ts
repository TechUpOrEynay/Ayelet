...
export const routes: Routes = [
  ...
  },
  {
    path: 'projects', component: ProjectsComponent,
    children: [
      { path: 'intresting/:id', component: ProjectIntrestingComponent },
      { path: 'volunteer/:id', component: ProjectVolunteerComponent },
      { path: 'embed/:id', component: ProjectEmbedComponent },
    ]
  },
